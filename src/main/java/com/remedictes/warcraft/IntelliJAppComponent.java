package com.remedictes.warcraft;
...
import com.remedictes.warcraft.listeners.*;
import com.remedictes.warcraft.sounds.SilentSound;
import com.remedictes.warcraft.sounds.Sounds;
...
public class IntelliJAppComponent implements ApplicationComponent {
    ...
    public void init() {
        ...
        if (SystemInfo.isLinux && clipProperty != null
                && clipProperty.equals("org.classpath.icedtea.pulseaudio.PulseAudioMixerProvider")) {
